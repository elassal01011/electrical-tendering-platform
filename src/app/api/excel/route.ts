...
import { logGenericExcelError } from "@/lib/services/excel/genericDiagnostics";
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    logGenericExcelError(error, stage);
