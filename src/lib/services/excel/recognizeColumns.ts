...
const rules: Rule[] = [
  ...
  ["componentCode", ["component code", "internal code", "material code"]],
  ["series", ["series", "product series", "range"]],
  ["category", ["category", "product category", "family"]],
  ["subcategory", ["subcategory", "sub category", "product group"]],
  [
    "partNumber",
    [
      "part number",
  ...
  ["tripType", ["trip type", "trip unit", "release", "release type"]],
  ["mountingType", ["mounting", "mounting type", "installation"]],
  ["status", ["status", "active", "product status"]],
